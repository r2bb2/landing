...
export default function ZorrIDCard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-100 p-4 overflow-y-auto">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-8">
        <div className="text-center mb-8">
          ...
          <p className="text-rozu-purple-dark text-lg font-poppins mb-6">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-rozu-pink-light shadow-xl rounded-3xl">
          <CardHeader className="bg-gradient-to-r from-rozu-pink-light/30 to-rozu-blue-light/30 rounded-t-3xl">
            ...
            <CardDescription className="text-rozu-purple-dark/70 font-poppins">
          ...
          <CardContent className="space-y-6 p-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`border-rozu-pink-light focus:border-rozu-pink focus:ring-2 focus:ring-rozu-pink/20 font-poppins rounded-xl ${
                    errors.name ? "border-red-300 focus:border-red-400" : ""
                  }`}
                />
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-rozu-purple-dark/60 font-poppins">
            ...
            <div className="space-y-2">
              <Label htmlFor="pronouns" className="text-rozu-purple-dark font-medium font-poppins">
                Pronombres 🦊 <span className="text-rozu-purple-dark/60 text-sm">(Opcional)</span>
              </Label>
              <Select
              ...
              >
                <SelectTrigger className="border-rozu-pink-light focus:border-rozu-pink focus:ring-rozu-pink-light font-poppins rounded-xl">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                >
                  <SelectTrigger
                    className={`border-rozu-pink-light focus:border-rozu-pink focus:ring-rozu-pink-light font-poppins rounded-xl ${
                  ...
                  <SelectContent className="z-50 max-h-60 rounded-xl">
                ...
                <Button
                  ...
                  className="border-rozu-pink-light text-rozu-pink hover:bg-rozu-pink-light shrink-0 bg-transparent rounded-full"
            ...
            <div className="space-y-2">
              ...
              <div
                className={`border-2 border-dashed rounded-xl p-6 text-center hover:border-rozu-pink transition-colors ${
              ...
              >
                ...
                <label htmlFor="avatar" className="cursor-pointer">
                  ...
                  <p className="text-rozu-purple-dark font-poppins">Haz clic para subir tu foto</p>
                  <p className="text-sm text-rozu-purple-dark/60 mt-1 font-poppins">PNG, JPG hasta 10MB</p>
                </label>
              </div>
              {errors.avatar && (
                <p className="text-red-500 text-sm font-poppins flex items-center gap-1">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-rozu-purple-medium shadow-xl rounded-3xl">
          <CardHeader className="bg-gradient-to-r from-rozu-purple-medium/20 to-rozu-pink-light/30 rounded-t-3xl">
            <CardTitle className="text-2xl text-rozu-purple-dark flex items-center gap-2 font-poppins">
